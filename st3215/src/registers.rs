...
impl Register {
    pub fn from_str(str: &str) -> Option<Self> {
        match str {
            "FirmwareMajorVersionNumber" => Some(Self::FirmwareMajorVersionNumber),
            "FirmwareSubVersionNumber" => Some(Self::FirmwareSubVersionNumber),
            "ServoMainVersionNumber" => Some(Self::ServoMainVersionNumber),
            "ServoSubVersionNumber" => Some(Self::ServoSubVersionNumber),
            "ID" => Some(Self::ID),
            "BaudRate" => Some(Self::BaudRate),
            "ReturnDelay" => Some(Self::ReturnDelay),
            "ResponseStatusLevel" => Some(Self::ResponseStatusLevel),
            "MinimumAngleLimitation" => Some(Self::MinimumAngleLimitation),
            "MaximumAngleLimitation" => Some(Self::MaximumAngleLimitation),
            "MaximumTemperatureLimit" => Some(Self::MaximumTemperatureLimit),
            "MaximumInputVoltage" => Some(Self::MaximumInputVoltage),
            "MinimumInputVoltage" => Some(Self::MinimumInputVoltage),
            "MaximumTorque" => Some(Self::MaximumTorque),
            "Phase" => Some(Self::Phase),
            "UnloadingCondition" => Some(Self::UnloadingCondition),
            "LEDAlarmCondition" => Some(Self::LEDAlarmCondition),
            "ProportionalityCoefficient" => Some(Self::ProportionalityCoefficient),
            "DifferentialCoefficient" => Some(Self::DifferentialCoefficient),
            "IntegralCoefficient" => Some(Self::IntegralCoefficient),
            "MinimumStartupForce" => Some(Self::MinimumStartupForce),
            "ClockwiseInsensitiveArea" => Some(Self::ClockwiseInsensitiveArea),
            "CounterclockwiseInsensitiveRegion" => Some(Self::CounterclockwiseInsensitiveRegion),
            "ProtectionCurrent" => Some(Self::ProtectionCurrent),
            "AngularResolution" => Some(Self::AngularResolution),
            "PositionCorrection" => Some(Self::PositionCorrection),
            "OperationMode" => Some(Self::OperationMode),
            "ProtectiveTorque" => Some(Self::ProtectiveTorque),
            "ProtectionTime" => Some(Self::ProtectionTime),
            "OverloadTorque" => Some(Self::OverloadTorque),
            "SpeedClosedLoopPProportionalCoefficient" => Some(Self::SpeedClosedLoopPProportionalCoefficient),
            "OverCurrentProtectionTime" => Some(Self::OverCurrentProtectionTime),
            "VelocityClosedLoopIIntegralCoefficient" => Some(Self::VelocityClosedLoopIIntegralCoefficient),
            "TorqueSwitch" => Some(Self::TorqueSwitch),
            "Acceleration" => Some(Self::Acceleration),
            "TargetLocation" => Some(Self::TargetLocation),
            "RunningTime" => Some(Self::RunningTime),
            "RunningSpeed" => Some(Self::RunningSpeed),
            "TorqueLimit" => Some(Self::TorqueLimit),
            "LockMark" => Some(Self::LockMark),
            "CurrentLocation" => Some(Self::CurrentLocation),
            "CurrentSpeed" => Some(Self::CurrentSpeed),
            "CurrentLoad" => Some(Self::CurrentLoad),
            "CurrentVoltage" => Some(Self::CurrentVoltage),
            "CurrentTemperature" => Some(Self::CurrentTemperature),
            "AsynchronousWriteFlag" => Some(Self::AsynchronousWriteFlag),
            "ServoStatus" => Some(Self::ServoStatus),
            "MobileSign" => Some(Self::MobileSign),
            "CurrentCurrent" => Some(Self::CurrentCurrent),
            _ => None,
        }
    }
